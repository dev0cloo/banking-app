    ...
    <section id="product" className={`${layout.sectionReverse} gap-6`}>
      ...
      <div className={`${layout.sectionInfo}`}>
        ...
        >
          ...
          directly from the platform. With these tools at your fingertips, you
          can stay on top of your billing and keep your finances organized with
          ease.
        </motion.p>
        <motion.div
