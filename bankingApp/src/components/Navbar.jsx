    ...
    <nav className="w-full flex py-6 justify-between items-center navbar">
      ...
      <ul className="list-none sm:flex hidden justify-end items-center flex-1 ">
        ...
        {navLinks.map((nav, index) => (
          <li
            key={nav.id}
            className={`font-poppins font-normal cursor-pointer hover:text-secondary text-[16px] text-white ${
      ...
      <div className={`flex sm:hidden flex-1 justify-end items-center`}>
        ...
        <div
          className={`${
            toggle ? "flex" : "hidden"
          } p-6 bg-black-gradient absolute z-[5] rounded-xl sidebar top-20 right-0 mx-4 my-2 min-w-[140px]`}
        >
